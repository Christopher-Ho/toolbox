...
class LinkedList:
    ...
    def size(self):
        """
        :return: the number of nodes in the list and takes O(n) time
        """
        current = self.head
        count = 0
...
def main():
    ...
    # adds two new nodes to the current list
    l.add(20)
    l.add(30)
    l.add(40)
    print("The size of the linked list is: ", l.size(), " and the elements are: ", l)
